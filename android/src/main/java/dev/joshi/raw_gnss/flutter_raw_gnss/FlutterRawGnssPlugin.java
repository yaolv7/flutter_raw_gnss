package dev.joshi.raw_gnss.flutter_raw_gnss;
...
/** FlutterRawGnssPlugin */
public class FlutterRawGnssPlugin implements FlutterPlugin {
  ...
  public static void registerWith(Registrar registrar) {
    FlutterRawGnssPlugin plugin = new FlutterRawGnssPlugin();
